...
export const uploadFileToIPFS = async(file) => {
    ...
    const metadata = JSON.stringify({       // metadata is optional
        name: 'testname',
        keyvalues: {
    ...
    return axios 
        ...
        .then(function (response) {
            ...
            return {
               success: true,
               pinataURL: "https://gateway.pinata.cloud/ipfs/" + response.data.IpfsHash     // this is the URL to the file on IPFS
           };
        })
        .catch(function (error) {
            console.log(error)
